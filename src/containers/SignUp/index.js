...
class SignUpScreen extends Component {
  constructor(props) {
    ...
    this.onNacimientoEditHandle = (nac) => this.setState({ nac });
    this.onSexoEditHandle = (sex) => this.setState({ sex });
        ...
        <KeyboardAwareScrollView
          ...
          <View style={styles.formContainer}>
            ...
            <TextInputMask
              ...
              style={styles.input(text)}
              onChangeText={this.onNacimientoEditHandle}
            ...
            <RNPickerSelect
              onValueChange={this.onSexoEditHandle}
              style={pickerStyle}
              value={sex}
              placeholder={{
                label: 'Sexo',
