    ...
    return (
      <View style={styles.footer}>
        <Button
          ...
          style={[styles.button, { borderColor: '#ff1744' }]}
          textStyle={[styles.buttonText, { color: '#ff1744' }]}
        ...
        <Button
          ...
          style={[styles.button, { borderColor: '#767676' }]}
          textStyle={[styles.buttonText, { color: '#767676' }]}
