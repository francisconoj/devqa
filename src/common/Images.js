...
const Images = {
  LogoGreen: require("@images/devola_green.png"),
  LogoGreenGif: require("@images/logo_devola.gif"),
  LogoBlue: require("@images/devola_blue.png"),
  Logo: require("@images/logo.png"),
  Google: require("@images/google.png"),
  Facebook: require("@images/Facebook_logo_square.png"),
  Apple: require("@images/Logo_Apple.gif"),
  ...
  IconDevola: require("@images/icono_devola.png"),
  IconBell: require("@images/bell.png"),
  IconBellNotif: require("@images/bell-notif.png"),
};
