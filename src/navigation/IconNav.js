...
const Back2 = (navigation, iconBack, dark) => (
  <TouchableOpacity
    style={Styles.Common.viewBack}
    hitSlop={hitSlop}
    onPress={() => {
...
const RightIcon = (icon, onPress, dark) => (
  <View style={[Styles.Common.Row]}>
    <NavigationBarIcon icon={icon} size={24} color="#08eabe" />
  </View>
);

const RightIconWhite = (icon, onPress, dark) => (
  <View style={[Styles.Common.Row]}>
    <NavigationBarIcon icon={icon} size={24} onPress={onPress} color="##ffffff" />
  </View>
);
